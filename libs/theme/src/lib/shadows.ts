...
export const createShadows: (palette: PaletteOptions) => Shadows = (
...
export const createCustomShadows: (palette: PaletteOptions) => CustomShadows = (
  palette: PaletteOptions
) => {
  const color = palette.grey?.[500] || "#919EAB";
  ...
  const primary = palette.primary
    ? (palette.primary as SimplePaletteColorOptions)
    : { main: "#000" };
  const secondary = palette.secondary
    ? (palette.secondary as SimplePaletteColorOptions)
    : { main: "#000" };
  const info = palette.info
    ? (palette.info as SimplePaletteColorOptions)
    : { main: "#000" };
  const success = palette.success
    ? (palette.success as SimplePaletteColorOptions)
    : { main: "#000" };
  const warning = palette.warning
    ? (palette.warning as SimplePaletteColorOptions)
    : { main: "#000" };
  const error = palette.error
    ? (palette.error as SimplePaletteColorOptions)
    : { main: "#000" };
